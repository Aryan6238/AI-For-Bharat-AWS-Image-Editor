...
window._workshopConfig = {
  cognito: {
    userPoolId: 'REPLACE_WITH_YOUR_POOL_ID', // e.g. us-west-2_uXboG5pAb
    userPoolClientId: 'REPLACE_WITH_YOUR_CLIENT_ID', // e.g. 25ddkmj4v6hfsfvruhpfi7n4hv
    region: 'YOUR_AWS_REGION' // e.g. us-west-2
  },
  api: {
    invokeUrl: 'REPLACE_WITH_YOUR_INVOKE_URL' // e.g. https://abc123def.execute-api.us-west-2.amazonaws.com/prod
  }
};
